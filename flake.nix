{
  description = "zerotier-k8s-link - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 zerotier-k8s-link development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P zerotier-k8s-link.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/zerotier-k8s-link $out/bin/  # Rust
            # cp bin/zerotier-k8s-link $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/zerotier-k8s-link";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-zerotier-k8s-link" {
