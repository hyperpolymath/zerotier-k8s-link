...
// Replace zerotier-k8s-link, Zerotier K8S Link — See README.adoc for details., just run, Zerotier K8S Link started successfully. with actuals
= zerotier-k8s-link — Quick Start for Users
:toc:
:toclevels: 2

== What is zerotier-k8s-link?

Zerotier K8S Link — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./zerotier-k8s-link-portable
----
...
[source]
----
Zerotier K8S Link started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/zerotier-k8s-link/wiki
