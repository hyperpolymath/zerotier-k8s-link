...
git clone https://github.com/hyperpolymath/zerotier-k8s-link.git cd
zerotier-k8s-link
...
toolbox create zerotier-k8s-link-dev toolbox enter zerotier-k8s-link-dev
...
zerotier-k8s-link/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
