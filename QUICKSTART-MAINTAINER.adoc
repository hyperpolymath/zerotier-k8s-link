...
// Replace zerotier-k8s-link, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= zerotier-k8s-link — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining zerotier-k8s-link for
...
podman build -t zerotier-k8s-link .
----
...
* Upstream: https://github.com/hyperpolymath/zerotier-k8s-link/issues
